        ...
        <div className="shadow-md w-full fixed top-0 left-0 text-teal-800 z-[20]">
            <div className="md:flex items-center justify-between bg-white py-4 md:px-10 px-7 dark:bg-slate-800 dark:text-gray-300">
                <div className="font-bold text-2xl cursor-pointer flex items-center">
                    <a href="/" className="hover:text-gray-400 text-teal-800 dark:text-cyan-500">Taylor Ambrose</a>
                </div>
                ...
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 ${open ? 'top-15 block bg-white dark:bg-slate-800' : 'top-[-490px]'}`}>
                    {
                        Links.map((link) => (
